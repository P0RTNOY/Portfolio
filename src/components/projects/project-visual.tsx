...
export function ProjectVisual({ imageUrl, title, className }: ProjectVisualProps) {
  if (imageUrl) {
    return (
      <div
  ...
  return (
    <div
      ...
      role="img"
    >
      <div className="absolute inset-0 bg-[linear-gradient(135deg,rgba(20,184,166,0.3),transparent_35%),linear-gradient(315deg,rgba(245,158,11,0.32),transparent_36%)]" />
